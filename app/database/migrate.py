...
class Migrate:
    def __init__(self):
        ...
        dict_user = [
            {"name":"Lazuardy Khatulistiwa", "address":"Daksinapati 123", "email": "user@user.com", "phone":"081395863285", "username":"user", "password":"user", "role":"user"},
            {"name":"Lazuardy Khatulistiwa", "address":"Daksinapati 123", "email": "admin@admin.com", "phone":"081395863285", "username":"admin", "password":"admin", "role":"admin"}
        ]
